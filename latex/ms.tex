...
\end{equation}
Hence
$$p(\tilde\Delta | \Delta) = \frac{1}{\sqrt{2\pi\sigma^2}}x\exp \left(-\frac{(\tilde\Delta-\Delta)^2}{2\sigma^2}\right)$$
...
\begin{proof}{gaussians_product_integral}
    p(\bm{f} \vert T_k, D, \Delta) = \mathcal{L}_k  \sqrt{\frac{2\pi\sigma_{k}^2}{\sigma^{2} + \sigma_{k}^{2}}} \exp\left(-\frac{1}{2}\frac{(\Delta_k-\Delta)^2}{\sigma_k^2 + \sigma^2}\right)
\end{proof}
And \autoref{eq:goal} gives 
\begin{equation}\label{eq:result}
    \ln p(\bm{f} \vert P, T_0 ,D, \Delta) =  \sum_{k}^K \ln \mathcal{L}_k  - \frac{1}{2} \sum_k^K\left(\ln(2\pi\sigma_{k}^2) + \ln(\sigma^{2} + \sigma_{k}^{2}) +  \frac{\left(\Delta_{k} -
