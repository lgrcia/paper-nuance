...
\begin{figure}[H]
    \begin{centering}
        \includegraphics[width=8.5cm]{../workflows/plot_issues/figures/issue1.pdf}
...
\begin{figure}[H]
    \begin{centering}
        \includegraphics[width=1\linewidth]{../workflows/plot_issues/figures/issue2.pdf}
...
\begin{figure}[H]
    \begin{centering}
        \includegraphics[width=0.85\linewidth]{../workflows/principle/figures/principle_linear_search.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{../workflows/principle/figures/principle_periodic_0.pdf}\\
    {(a) $\ln \mathcal{L}$}

    \centering
    \includegraphics[width=0.85\linewidth]{../workflows/principle/figures/principle_periodic_1.pdf}\\
    {(b) $\mathcal{P}(P)$}
\end{figure}
...
\begin{figure}[H]
    \begin{centering}
        \includegraphics[width=0.85\linewidth]{../workflows/principle/figures/principle_Q.pdf}
...
\begin{figure}[H]
    \begin{centering}
        \includegraphics[width=0.75\linewidth]{../workflows/principle/figures/principle_dataset_decomposed.pdf}
