...
main.set_ylabel(
    r"$\delta \propto \frac{\mathrm{variability\; amplitude}}{\mathrm{transit\;depth}}$",
    fontsize=14,
)
main.set_xlabel(
    r"$\tau \propto \frac{\mathrm{variability\; timescale}}{\mathrm{transit\;duration}}$",
    fontsize=14,
)
params = true_depth
...
def title(ax, v, a):
    ax.set_title(rf"$\tau = {v:.1f}$  $\delta = {a:.1f}$", fontsize=12)
